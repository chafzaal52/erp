...
router.get('/', function (req, res, next) {
    res.send("USuppliers_Disc1 Work properly");
});


router.get('/GetById/:Id', function (req, res, next) {
    var Id= req.params.Id;
    var query="select *  from USuppliers_Disc1 where SCode="+Id+";";
   ...
   router.post('/InsertUpdate', function (req, res, next) {
    ...
    sql.connect(config).then(response => {
        ...
        .execute('sp_InsertUpdateUSuppliers_Disc1')
    }).then(result => {
        res.send("Success");
    }).catch(err => {
        res.send({ err });
...
router.delete('/Delete/:Id', function (req, res, next) {
    var Id= req.params.Id;
    var query="delete from USuppliers_Disc1 where SCode="+Id+";";
