...
router.get('/GetList/:CompanyId', function (req, res, next) {
    ...
    let query="select * from Department where CompanyId="+CompanyId+";";
...
router.get('/GetById/:Id', function (req, res, next) {
   ...
   router.post('/InsertUpdate', function (req, res, next) {
    ...
    sql.connect(config).then(response => {
        ...
        .input('DepartmentName',model.DepartmentName)
        .input('DepartmentType',model.DepartmentType)
        ...
        .execute('sp_InsertUpdatewebDepartment')
    }).then(result => {
