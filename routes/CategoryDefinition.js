...
router.get('/', function (req, res, next) {
    res.send("Category Definition work properly");
});


router.get('/GetList/:CompanyID', function (req, res, next) {
    let CompanyID= req.params.CompanyID;
    let query="select * from uCategory where CompanyID="+CompanyID;
...
router.get('/GetById/:Id', function (req, res, next) {
    ...
    var query="select *  from uCategory where ID="+Id+";";
    new sql.connect(config).then(pool=> {   
        return pool.request()
                .query(query)
                .then(result => {
   ...
   router.post('/InsertUpdate', function (req, res, next) {
    ...
    sql.connect(config).then(response => {
        ...
        .input('Id',model.ID)
        .input('CategoryCode',model.CategoryCode)
        ...
        .execute('sp_InsertUpdateuCategory')
    }).then(result => {
        //res.send("Success");
...
router.delete('/Delete/:Id', function (req, res, next) {
    var Id= req.params.Id;
    var query="delete from uCategory where ID="+Id+";";
